  ...
  mount(`
    <section class="mx-auto max-w-2xl animate-fade-in">
      ...
      <div class="rounded-2xl border border-slate-200 bg-white/80 p-6 shadow-card backdrop-blur dark:border-slate-700/70 dark:bg-slate-800/60 sm:p-8">
        ...
        <div class="mt-5 rounded-xl border border-amber-300/70 bg-amber-50 px-4 py-3 text-sm text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200">
          <p class="flex items-center gap-1.5 font-semibold">
            <svg class="h-4 w-4 flex-none" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
            提出についての注意
          </p>
          <ul class="mt-1.5 list-disc space-y-0.5 pl-5">
            <li><strong>最後の問題まで回答し、結果画面に到達した時点で1回だけ自動送信</strong>されます。</li>
            <li>途中で終了・離脱した場合は<strong>送信されず、採点もされません</strong>（途中までの回答は提出されません）。</li>
            <li>提出するには、必ず最後の問題まで回答してください。</li>
          </ul>
        </div>
